...
namespace HabitFlow.Application.Features.Habits.Commands.CreateHabit.Validators;
...
public class CreateHabitValidator : AbstractValidator<CreateHabitDto>
{
    ...
    {
        RuleFor(x => x.Name)
            .NotEmpty().WithMessage("Nome do hábito é obrigatório.")
            .MaximumLength(100).WithMessage("Nome do hábito deve ter no máximo 100 caracteres.");
